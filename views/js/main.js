...
var resizePizzas = function(size) {
  ...
  function changePizzaSizes(size) {
    ...
    var pizzasArr = document.getElementsByClassName("randomPizzaContainer");

    for (var i = 0; i < pizzasArr.length; i++) {
        pizzasArr[i].style.width = newWidth + "%";
    }  
...
document.addEventListener('DOMContentLoaded', function() {
  var cols = 8;
  var s = 256;
  //reduced number of pizzas depending on screen size
  var numPizzas = cols * (window.innerHeight / 250 );
